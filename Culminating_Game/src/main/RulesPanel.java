...
public class RulesPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.drawString("Mouse - Aim", textX, y);
        y += 35;

        g2.drawString("Left Click - Attack", textX, y);
        y += 35;

        g2.drawString("Defeat enemies to survive", textX, y);
        y += 35;

        g2.drawString("Clear rooms to win", textX, y);
