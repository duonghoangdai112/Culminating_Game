 ...
 *
 * Drop this panel into any JFrame and call requestFocusInWindow()
 * after the frame becomes visible.
 */
public class Menu extends JPanel {
    ...
    // ── Selection-changed callback (wire up your screen transitions here) ─────
    ...
    // ── Background: radial gradient + pixel-dot texture ───────────────────────
    ...
    private void paintTitle(Graphics2D g2, int W, int H) {
        ...
        // Outer bevel highlight (top/left edge)
    ...
    private void paintButton(Graphics2D g2, int bx, int by, String label, boolean active) {
        if (active) {
            ...
            // Outermost glow layer (orange-red)
